"""
    Auto-generated service class: BankBalanceAPI
    Generated at: C:\Users\arun\Documents\ussdgw\src\services\BankAPI.py
"""
...
class BankBalanceAPI(ServiceABC):
    ...
    def getUrl(self, *args, **kwargs) -> str:
        ...
        return f"{self.baseurl}api/bankbalanceapi"
    
    def getPayload(self, *args, **kwargs) -> Dict:
        """Create the JSON payload for the API request."""
        return {
            "service": "BankBalanceAPI",
