"""
    Auto-generated service class: BundleTopupAPI
    Generated at: C:\Users\arun\Documents\ussdgw\src\services\BundleTopupAPI.py
"""
...
class BundleTopupAPI(ServiceABC):
    ...
    def getUrl(self, *args, **kwargs) -> str:
        ...
        return f"{self.baseurl}api/bundletopupapi"
    
    def getPayload(self, *args, **kwargs) -> Dict:
        """Create the JSON payload for the API request."""
        return {
            "service": "BundleTopupAPI",
