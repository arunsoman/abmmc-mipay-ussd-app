"""
    Auto-generated service class: BillPaymentAPI
    Generated at: C:\Users\arun\Documents\ussdgw\src\services\BillAPI.py
"""
...
class BillPaymentAPI(ServiceABC):
    ...
    def getUrl(self, *args, **kwargs) -> str:
        ...
        return f"{self.baseurl}api/billpaymentapi"
    
    def getPayload(self, *args, **kwargs) -> Dict:
        """Create the JSON payload for the API request."""
        return {
            "service": "BillPaymentAPI",
