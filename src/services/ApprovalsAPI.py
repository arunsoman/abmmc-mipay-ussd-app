"""
    Auto-generated service class: ApprovalsAPI
    Generated at: C:\Users\arun\Documents\ussdgw\src\services\ApprovalsAPI.py
"""
...
class ApprovalsAPI(ServiceABC):
    ...
    def getUrl(self, *args, **kwargs) -> str:
        ...
        return f"{self.baseurl}api/approvalsapi"
    
    def getPayload(self, *args, **kwargs) -> Dict:
        """Create the JSON payload for the API request."""
        return {
            "service": "ApprovalsAPI",
