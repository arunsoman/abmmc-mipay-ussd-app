"""
    Auto-generated service class: SetLanguageAPI
    Generated at: C:\Users\arun\Documents\ussdgw\src\services\LanguageAPI.py
"""
...
class SetLanguageAPI(ServiceABC):
    ...
    def getUrl(self, *args, **kwargs) -> str:
        ...
        return f"{self.baseurl}api/setlanguageapi"
    
    def getPayload(self, *args, **kwargs) -> Dict:
        """Create the JSON payload for the API request."""
        return {
            "service": "SetLanguageAPI",
